...
void main() {
  ...
  Duration testDuration1 =
      const Duration(days: 2, hours: 15, minutes: 30, seconds: 13);
  ...
  Duration testDuration2 = const Duration(microseconds: 30);
  testWidgets('return 0 m for duration for en locale', (widgetTester) async {
    await widgetTester.pumpWidget(
      TestMaterialApp(
        locale: enLocale,
        child: LocalizedText(
  ...
  Duration testDuration3 = const Duration(minutes: 0, seconds: 40);
  testWidgets('return 40 s for duration for en locale', (widgetTester) async {
    await widgetTester.pumpWidget(
      TestMaterialApp(
        locale: enLocale,
        child: LocalizedText(
